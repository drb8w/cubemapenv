...
namespace TotalGlobal
{
	...
	public:
		TextureBoxFramebuffer(GLuint index_cubemap_render_prog, const std::vector<sb7::object *> &objects, GLsizei width = 512, GLsizei height = 512)
		...
		GLuint GetTextureBoxColorTextureIndex()
		{
